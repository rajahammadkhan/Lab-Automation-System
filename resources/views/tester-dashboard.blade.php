            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="counter-box text-center white">
                        ...
                        <h3 class="m-b-10">{{count($data['user'])}}
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="counter-box text-center white">
                        <div class="text font-17 m-b-5">Total Request</div>
                        <h3 class="m-b-10">{{count($data['testing'])}}
                            <i class="material-icons col-green">trending_up</i>
                        </h3>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="counter-box text-center white">
                        <div class="text font-17 m-b-5">Total Approved</div>
                        <h3 class="m-b-10">{{count($data['approved'])}}
                            <i class="material-icons col-green">trending_up</i>
                        </h3>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="counter-box text-center white">
                        <div class="text font-17 m-b-5">Total Rejected</div>
                        <h3 class="m-b-10">{{count($data['rejected'])}}
