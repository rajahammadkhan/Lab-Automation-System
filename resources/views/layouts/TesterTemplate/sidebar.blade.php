        ...
        <ul class="list">
            <li class="sidebar-user-panel active">
                <div class="user-panel">
                    <div class=" image">
                        <img src="{{asset('raja/images/usrbigg.jpg')}}" class="img-circle user-img-circle" alt="User Image">
                    </div>
                </div>
                <div class="profile-usertitle">
                    <div class="sidebar-userpic-name">{{App\Helpers\Sc::getUserProfile()->name}}</div>
                    <div class="profile-usertitle-job ">Tester</div>
                </div>
            </li>
            <li class="active">
                <a href="{{url('tester-dashboard')}}" class="">
            ...
            <li>
                ...
                <ul class="ml-menu">
                    <li>
                        <a href="{{url('user-detail')}}">All Users</a>
                    </li>
                </ul>
            <li>
            <li>
                ...
                <ul class="ml-menu">
                    <li>
                        <a href="{{url('testing-request')}}">All Request</a>
                    </li>
                </ul>
            </li>
            <li>
