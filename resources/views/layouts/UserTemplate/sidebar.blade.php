            ...
            <ul class="list">
                <li class="sidebar-user-panel active">
                    <div class="user-panel">
                        <div class=" image">
                            <img src="{{asset('raja/images/hh.jpg')}}" class="img-circle user-img-circle" alt="User Image">
                        </div>
                    </div>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        ...
                        <li>
                            <a href="{{url('category')}}">All Category</a>
                        </li>
                    </ul>
                <li>
                <li>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{url('testing')}}">Testing Request</a>
                        </li>
                    </ul>
                <li>
                    <a href="#" onClick="return false;" class="menu-toggle">
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{url('approved')}}">All Approved</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{url('rejected')}}">All Rejected</a>
                        </li>
                    </ul>
                <li>
            </ul>
